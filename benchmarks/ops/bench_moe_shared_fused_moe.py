...
def test_shared_fused_moe_bench(
    ...
    if _VLLM_AVAILABLE:
        ...
        # No baseline rather than a misleading one. The per-expert Python loop this
        # used to time is a correctness reference: it upcasts to fp32 and index_add_s
        # one expert at a time, so "TileOPs is 30x faster" said nothing about either.
        warnings.warn(
